...
async function selecionarRegiao(regiaoId, evt) {
  try {
    ...
    // Carregar semáforos e postes quando selecionar região
    carregarSemaforos()
    carregarPostes()
    atualizarDashboard()
  } catch (e) {
...
async function criarDadosMock() {
  ...
  try {
    ...
    // Criar semáforos e postes para cada região
